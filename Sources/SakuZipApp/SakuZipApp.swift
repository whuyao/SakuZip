...
@MainActor
final class SakuZipApplicationDelegate: NSObject, NSApplicationDelegate {
...
@main
struct SakuZipApp: App {
    @NSApplicationDelegateAdaptor(SakuZipApplicationDelegate.self)
    ...
    init() {
        ...
        _jobs = StateObject(wrappedValue: JobStore())
        _workflows = StateObject(wrappedValue: WorkflowStore())
    }
